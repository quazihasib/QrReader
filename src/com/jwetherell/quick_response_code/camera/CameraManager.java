...
import com.example.fastgive.PlanarYUVLuminanceSource;
...
public final class CameraManager {
    ...
    public Rect getFramingRect() {
        if (framingRect == null) {
            ...
            int width = getScreenWidth(CaptureActivity.captureInstance);
//            if (width < MIN_FRAME_WIDTH) {
//                width = MIN_FRAME_WIDTH;
//            } else if (width > MAX_FRAME_WIDTH) {
//                width = MAX_FRAME_WIDTH;
//            }
            int height = getScreenHeight(CaptureActivity.captureInstance);
